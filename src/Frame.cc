...
Frame::Frame(const Frame& frame)
    : mpORBvocabulary(frame.mpORBvocabulary),
      ...
      mSift(frame.mSift.clone()),
      mSiftRight(frame.mSiftRight.clone()),
...
void Frame::ExtractORB(int flag, const cv::Mat& im)
{
    if (flag == 0)
    {
        ...
        // cout << "feat extraction time: " << t1 << " " << t2 << endl;
    }
    else
    {
...
void Frame::ComputeStereoMatches()
{
    ...
    for (int iL = 0; iL < N; iL++)
    {
        ...
        //***** only consider features in a pre-decided smaller window (for example, 1280x720 -> 1080x640)*****
        // if(kpL.pt.x<100 || kpL.pt.x>1179 || kpL.pt.y<40 || kpL.pt.y>679)  // 100  1179  40  679; 150 1769 60 1019
        //     continue;
