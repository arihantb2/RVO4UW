...
public:
    ...
    int SearchByQuad(Frame& CurrentFrame, const Frame& LastFrame, vector<int>& TemperalMatch);
    int SearchByQuadKeyFrame(KeyFrame* pKF, Frame& F, vector<MapPoint*> vpMapPointsKF);
